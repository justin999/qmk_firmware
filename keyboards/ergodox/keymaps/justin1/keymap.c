 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | Spot |  Copy| PASTE| Alt  | LGui |                                       | RGUI | Left |  Dn  |  Up  | Right  | 
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | Copy |PASTE |       |   `  | ESC  |
 *                                 ,------|------+------|       |------+------+------.
...
// Otherwise, it needs KC_*
	...
	KC_LSPO,  KC_Z,    KC_X,    KC_C,     KC_V,     KC_B,    KC_B,
	LALT(KC_SPC),LGUI(KC_C),LGUI(KC_V), KC_LALT,  KC_LGUI,
	LGUI(KC_C),  LGUI(KC_V),
	SCMD(LCTL(KC_4)),
	...
	KC_B ,  KC_N,    KC_M,    KC_COMM,  KC_DOT,   KC_SLSH, KC_RSPC,
